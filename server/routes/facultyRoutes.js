...
router.post("/getattendance", auth, getAttendanceFaculty);
router.post("/getsubjectbydept", auth, getSubjectByDept);
router.post("/gettestbydept", auth, getTestByDept);
